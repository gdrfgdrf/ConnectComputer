...
@Condition(
        ...
        notSatisfiedResult = {
                ...
                ResultEnum.NETTY_CONTROLLER_IS_NOT_EXCHANGE_RSA_KEY
        }
)
@Handler(support = ControllerSecurityProto.EncryptBlockPacket.class)
@ClientVersion(version = VersionEnum.v1_0_0)
public class ControllerEncryptBlockPacketHandler implements PacketHandler<ControllerSecurityProto.EncryptBlockPacket> {
    @Override
    public void handle(Channel channel, BaseProto.Packet packet, ControllerSecurityProto.EncryptBlockPacket message) throws Exception {
        ...
        Writer.write(
                ...
                message,
                packet.getRequestId(),
                ResultEnum.NETTY_CONTROLLER_ENCRYPTED_MESSAGE
        );
    }
}
