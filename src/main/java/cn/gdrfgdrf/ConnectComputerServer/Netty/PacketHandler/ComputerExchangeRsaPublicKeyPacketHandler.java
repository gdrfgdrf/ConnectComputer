...
@Condition(
        ...
        notSatisfiedResult = {
                ...
                ResultEnum.NETTY_COMPUTER_ALREADY_EXCHANGED_RSA_KEY
        },
        need = {
                true,
                true,
...
@Handler(support = ComputerSecurityProto.ExchangeRsaPublicKeyPacket.class)
@ClientVersion(version = VersionEnum.v1_0_0)
public class ComputerExchangeRsaPublicKeyPacketHandler implements PacketHandler<ComputerSecurityProto.ExchangeRsaPublicKeyPacket> {
    @Override
    public void handle(Channel channel, BaseProto.Packet packet, ComputerSecurityProto.ExchangeRsaPublicKeyPacket message) throws Exception {
        ...
        Writer.write(
                ...
                message,
                packet.getRequestId(),
                ResultEnum.NETTY_COMPUTER_EXCHANGE_RSA_KEY
        );

        computerUser.setExchangeConnectionRsaKey(true);
    }
}
