...
import cn.gdrfgdrf.ConnectComputerServer.Validation.Validator.MaxAndMessageValidator;
...
@DefaultMessage(
        messageEnum = MessageEnum.VALIDATION_MAX
)
@Documented
@Constraint(validatedBy = { MaxAndMessageValidator.class })
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(MaxAndMessage.List.class)
public @interface MaxAndMessage {
