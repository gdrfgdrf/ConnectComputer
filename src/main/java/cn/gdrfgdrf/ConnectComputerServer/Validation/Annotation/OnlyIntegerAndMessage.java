...
import cn.gdrfgdrf.ConnectComputerServer.Validation.Validator.OnlyIntegerAndMessageValidator;
...
@DefaultMessage(
        messageEnum = MessageEnum.VALIDATION_ONLY_INTEGER
)
@Documented
@Constraint(validatedBy = { OnlyIntegerAndMessageValidator.class })
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(OnlyIntegerAndMessage.List.class)
public @interface OnlyIntegerAndMessage {
