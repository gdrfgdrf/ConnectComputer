...
import cn.gdrfgdrf.ConnectComputerServer.Validation.Validator.NotNullAndMessageValidator;
...
@DefaultMessage(
        messageEnum = MessageEnum.VALIDATION_NOT_NULL
)
@Documented
@Constraint(validatedBy = { NotNullAndMessageValidator.class })
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(NotNullAndMessage.List.class)
public @interface NotNullAndMessage {
