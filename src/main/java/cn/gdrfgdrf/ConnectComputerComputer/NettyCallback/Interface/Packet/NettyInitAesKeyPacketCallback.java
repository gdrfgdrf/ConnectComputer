...
import cn.gdrfgdrf.ConnectComputerComputer.Client.Netty.PacketHandler.InitAesKeyPacketHandler;
...
import cn.gdrfgdrf.ConnectComputerComputer.NettyCallback.Impl.Packet.NettyInitAesKeyPacketCallbackImpl;
 ...
 */
@CallbackInfo(
        targetClass = InitAesKeyPacketHandler.class,
        implementedClass = NettyInitAesKeyPacketCallbackImpl.class
)
public interface NettyInitAesKeyPacketCallback extends NettyCallback {
